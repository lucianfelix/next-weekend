...
export function generateMetadata() {
    return {
        title: 'Next Weekend Adventures',
        description: 'Next Weekend Adventures',
    ...
    return (<section className="">
        <div className="bg-white">
            <div className="py-10 mx-0 sm:py-16">
                <h2>
                    ...
                    <div className="mx-0 lg:relative">
                        <Image className="mx-0 w-full"
                               ...
                               height={717}
                        />
                        <div className="lg:absolute lg:bottom-0 max-w-[1136px] m-auto left-0 right-0 mh-5 lg:p-10 p-2 bg-white">
                            <div className="text-xl">Experience the world with us</div>
                            <div className="pt-5 text-base">With WKND Adventures, you don&lsquo;t just see the world -- you
                ...
                <div className="grid grid-cols-1 p-6 mt-6 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                    {adventures.map(
