...
Who is WKND's intended audience?
...
export default function Faqs() {
    return (
        <main className="bg-white text-lg">
            <div className="w-[776px] p-10 space-y-8">
                <h2 className="w-[84px] border-5 border-b-yellow"><span className="text-5xl my-10">FAQs</span></h2>
                <div>
